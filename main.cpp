...
static const string mainnet_seeds[] = {"static-faircoin2-seed1.fair-coin.org", ""};
static const string testnet_seeds[] = {"testnet-static-faircoin2-seed1.fair-coin.org", ""};
static const string *seeds = mainnet_seeds;

extern "C" void* ThreadSeeder(void*) {
  if (!fTestNet){
    db.Add(CService("toBeImplemented.onion", 40404), true);
  }
  do {
